...
CUDA_VISIBLE_DEVICES=1 llamafactory-cli train examples/train_lora/qwen3_lora_sft.yaml  >> log/DS-R1-0528-Qwen3-8B_cpp_completion_20250609_lora-sft_20250627.log
...
CUDA_VISIBLE_DEVICES=0 FORCE_TORCHRUN=1 NNODES=2 NODE_RANK=0 MASTER_ADDR=127.0.0.1 MASTER_PORT=45795  llamafactory-cli train examples/train_lora/qwen3_lora_dpo.yaml
CUDA_VISIBLE_DEVICES=1 FORCE_TORCHRUN=1 NNODES=2 NODE_RANK=1 MASTER_ADDR=127.0.0.1 MASTER_PORT=45795  llamafactory-cli train examples/train_lora/qwen3_lora_dpo.yaml
```
