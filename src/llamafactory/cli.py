...
def main():
    ...
    # print(f'set CUDA_VISIBLE_DEVICES to 1')
    print(f'command={command}, is_env_enabled("FORCE_TORCHRUN")={is_env_enabled("FORCE_TORCHRUN")}, get_device_count()={get_device_count()}')
    if command == "train" and (is_env_enabled("FORCE_TORCHRUN") or (get_device_count() > 1 and not use_ray())):
        print(f'launch distributed training')
